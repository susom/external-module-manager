 ...
 *
 * If Content-Encoding is not disabled, the plugin will add an Accept-Encoding header for the encoding methods it
 * supports.
 *
...
final class DecoderPlugin implements Plugin
{
     ...
     * @param array $config {
     *
     * @var bool $use_content_encoding Whether this plugin should look at the Content-Encoding header first or only at
     *     the Transfer-Encoding (defaults to true).
     * }
     */
