...
class Repo extends AbstractApi
{
     ...
     * Note: at time of writing this is an undocumented feature but GitHub support have advised that it can be relied
     * on.
     *
     * @link http://developer.github.com/v3/repos/
     ...
     * @param int $teamId The id of the team that will be granted access to this repository. This is only valid when
