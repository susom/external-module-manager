...
abstract class SeekableBodyPlugin implements Plugin
{
     ...
     * @param array $config {
     *
     * @var bool $use_file_buffer Whether this plugin should use a file as a buffer if the stream is too big, defaults
     *     to true
     * @var int $memory_buffer_size Max memory size in bytes to use for the buffer before it use a file, defaults to
     *     2097152 (2 mb)
     * }
     */
