...
final class RetryPlugin implements Plugin
{
     ...
     * @var callable $error_response_decider A callback that gets a request and response to decide whether the request
     *     should be retried
     * @var callable $exception_decider A callback that gets a request and an exception to decide after a failure
     *     whether the request should be retried
     * @var callable $error_response_delay A callback that gets a request and response and the current number of
     *     retries and returns how many microseconds we should wait before trying again
     * @var callable $exception_delay A callback that gets a request, an exception and the current number of retries
